...
from models import RboxFile, RboxFilePlug, RboxSingleFilePlug
...
class RboxFilePlugTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        file_system.save(self.filename, ContentFile("this is the file"))

    def get_file_obj(self, filename):
        return file_system.open(filename)
